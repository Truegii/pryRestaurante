...
//            Paragraph text2 = new Paragraph("Nro de Factura: \n0000"/**getFacturas.get(0).getFacnum(),font*/);
//            PdfPCell cell2 = new PdfPCell(new Paragraph());
//            cell2.addElement(text2);
//            cell2.setVerticalAlignment(PdfPCell.ALIGN_TOP);
//            cell2.setPaddingTop(200);
//            cell2.setPaddingRight(200);
//            cell2.setBorderWidth(1); // Establecer el ancho del borde
//            // Crear una tabla y agregar la celda
//            PdfPTable table2 = new PdfPTable(1);
//            table2.getDefaultCell().setFixedHeight(30f);
//            table2.setWidthPercentage(30); // Establecer el ancho de la tabla al 100% del ancho de la página
