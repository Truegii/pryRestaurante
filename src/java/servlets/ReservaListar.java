    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (filtro.equals("todos")) { //Lista todas las reservas
            ...
            try {
                ...
                Creator fabrica;
                fabrica = new CConcretePDF();
                IPDF pdf = fabrica.createReserva(listRes,ad.buscaUsuario(usu.getNombre()));
                pdf.export(response);
...
//                exportarReserva.export(response);
            ...
            try {
                ...
                Creator fabrica;
                fabrica = new CConcretePDF();
                IPDF pdf = fabrica.createDetaReserva(listRes,ad.buscaUsuario(listRes.get(0).getCorreo()));
                pdf.export(response);
